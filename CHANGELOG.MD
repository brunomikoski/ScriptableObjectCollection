...
## [1.9.8]
### Changed
- Fixed issue with name parser that would still treat digits as string and add to the final name
...
[1.9.8]: https://github.com/badawe/ScriptableObjectCollection/releases/tag/v1.9.8
