...
namespace BrunoMikoski.ScriptableObjectCollections
{
    ...
    public class CollectionCustomEditor : BaseEditor<CollectionCustomEditor>
    {
        ...
        protected virtual bool CanBeReorderable
        {
            get
            {
                // If this is a generated collection and it uses the order of items to match newly generated templates
                // to previously existing items, don't let the list be reordered. It just allows you to break things.
                if (IsAutoGenerated && generator.ItemToTemplateMatchingBehaviour 
                    == GeneratorItemToTemplateMatchingBehaviours.MatchByIndex)
                {
                    return false;
                }
                return true;
